...
impl Key {
    pub fn translate(self, lang: &Language) -> &'static str {
        match (self, lang) {
            ...
            (Key::LabelSessionTimeout, &Language::Zh) => "会话超时设置:",
            ...
            (Key::SpecTypeLabel, &Language::Zh) => "算法类型:",
            (Key::SpecTypeLabel, &Language::En) => "Algorithm Type:",
            (Key::SpecDraftNMaxLabel, &Language::Zh) => "最大推测数量:",
            (Key::SpecDraftNMaxLabel, &Language::En) => "Max Draft N:",
            (Key::SpecDraftNMinLabel, &Language::Zh) => "最小推测数量:",
            (Key::SpecDraftNMinLabel, &Language::En) => "Min Draft N:",
            (Key::SpecDraftPMinLabel, &Language::Zh) => "信任度:",
            (Key::SpecDraftPMinLabel, &Language::En) => "Trust Threshold (p-min):",
            (Key::SpecDraftPSplitLabel, &Language::Zh) => "分裂概率:",
            (Key::SpecDraftPSplitLabel, &Language::En) => "Split Probability (p-split):",
            ...
            (Key::CheckboxKvUnified, &Language::Zh) => "统一键值缓存",
            (Key::CheckboxKvUnified, &Language::En) => "Unified KV cache",
            (Key::CheckboxSwaFull, &Language::Zh) => "完整滑动窗口",
            (Key::CheckboxSwaFull, &Language::En) => "Full Sliding Window (SWA)",
            ...
            (Key::LabelGpuDevice, &Language::Zh) => "GPU 层数:",
            ...
            (Key::CheckboxCpuMoe, &Language::Zh) => "CPU MoE",
            (Key::CheckboxCpuMoe, &Language::En) => "CPU MoE",
