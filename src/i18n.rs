...
impl Key {
    pub fn translate(self, lang: &Language) -> &'static str {
        match (self, lang) {
            ...
            (Key::MenuItemAbout, &Language::Zh) => "ℹ️ 关于",
            (Key::MenuItemAbout, &Language::En) => "ℹ️ About",
            ...
            (Key::MenuItemCreateShortcut, &Language::Zh) => "🖥️ 创建桌面快捷方式",
            (Key::MenuItemCreateShortcut, &Language::En) => "🖥️ Create Desktop Shortcut",
            ...
            (Key::LabelBatchSize, &Language::Zh) => "最大批次大小 (--batch-size):",
            (Key::LabelBatchSize, &Language::En) => "Max Batch Size (--batch-size):",
            (Key::LabelUBatchSize, &Language::Zh) => "最大物理批次大小 (--ubatch-size):",
            ...
            (Key::LabelTemperature, &Language::Zh) => "温度 (--temp):",
            (Key::LabelTemperature, &Language::En) => "Temperature (--temp):",
