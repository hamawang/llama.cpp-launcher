...
pub enum Key {
    ...
    CheckboxIgnoreTemperature,
    CheckboxIgnoreTopP,
    CheckboxIgnoreTopK,
    CheckboxIgnoreRepeatPenalty,
    CheckboxIgnorePresencePenalty,
    LabelFlashAttn,
...
impl Key {
    pub fn translate(self, lang: &Language) -> &'static str {
        match (self, lang) {
            ...
            (Key::CheckboxIgnoreTemperature, &Language::Zh) => "忽略",
            (Key::CheckboxIgnoreTemperature, &Language::En) => "Ignore",
            (Key::CheckboxIgnoreTopP, &Language::Zh) => "忽略",
            (Key::CheckboxIgnoreTopP, &Language::En) => "Ignore",
            (Key::CheckboxIgnoreTopK, &Language::Zh) => "忽略",
            (Key::CheckboxIgnoreTopK, &Language::En) => "Ignore",
            (Key::CheckboxIgnoreRepeatPenalty, &Language::Zh) => "忽略",
            (Key::CheckboxIgnoreRepeatPenalty, &Language::En) => "Ignore",
            (Key::CheckboxIgnorePresencePenalty, &Language::Zh) => "忽略",
            (Key::CheckboxIgnorePresencePenalty, &Language::En) => "Ignore",
